...
res$sample$recruitmentSetting <- "prenatal clinic"; ### For example "antenatal clinic",or NA
...
res$variable[[length(res$variable) + 1]] <- list(
  variable = "Perceived riskiness of drinking during pregnancy was lower among women with greater numbers of previous alcohol problems",             ### Replace 'example' with variable name
  moment = 1,                       ### moment this variable was measured/manipulated
  type = "question",                ### "question", "aggregate", or "manipulation"
  datatype = "numeric",             ### "numeric", "logical", "nominal", "ordinal", or "text"
  values = NA,                      ### Possible values; NA or a vector, e.g. c(1, 2, 3)
  labels = NA,                      ### Labels for the values; NA or e.g. c("no", "maybe", "sometimes")
  description = "Perceived riskiness of drinking during pregnancy was lower among women with greater numbers of previous alcohol problems (p.364 figure 2)",					###	Provide the full description of the variable (e.g., questionnaire question)
...
####################################### ONLY FOR DETERMINANTS OF MATERNAL DRINKING BEHAVIOR VARIABLES
  ...
  determinant_original = "perceived risk",		### If reported, how do the authors categorized the determinant, e.g., "knowledge", "attitude", "risk perception"
...
res$variable[[length(res$variable) + 1]] <- list(
  variable = "Perceived riskiness of drinking during pregnancy was lower among women who had previously given birth to a healthy child",             ### Replace 'example' with variable name
  moment = 1,                       ### moment this variable was measured/manipulated
  type = "question",                ### "question", "aggregate", or "manipulation"
  datatype = "numeric",             ### "numeric", "logical", "nominal", "ordinal", or "text"
  values = NA,                      ### Possible values; NA or a vector, e.g. c(1, 2, 3)
  labels = NA,                      ### Labels for the values; NA or e.g. c("no", "maybe", "sometimes")
  description = "Perceived riskiness of drinking during pregnancy was lower among women who had previously given birth to a healthy child (p.364 figure 2)",					###	Provide the full description of the variable (e.g., questionnaire question)
...
res$variable[[length(res$variable) + 1]] <- list(
  variable = "Previous adverse pregnancy outcome did not predict perceived risk",             ### Replace 'example' with variable name
  moment = 1,                       ### moment this variable was measured/manipulated
  type = "question",                ### "question", "aggregate", or "manipulation"
  datatype = "numeric",             ### "numeric", "logical", "nominal", "ordinal", or "text"
  values = NA,                      ### Possible values; NA or a vector, e.g. c(1, 2, 3)
  labels = NA,                      ### Labels for the values; NA or e.g. c("no", "maybe", "sometimes")
  description = "Previous adverse pregnancy outcome did not predict perceived risk (p.364 figure 2)",					###	Provide the full description of the variable (e.g., questionnaire question)
