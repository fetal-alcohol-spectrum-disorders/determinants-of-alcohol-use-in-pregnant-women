...
res$variable[[length(res$variable) + 1]] <- list(
  variable = "So don’t worry and then I was of the view again based on some of the advice from my close friend that a small amount of alcohol is fine",             ### Replace 'example' with variable name
  moment = 1,                       ### moment this variable was measured/manipulated
  type = "question",                ### "question", "aggregate", or "manipulation"
  datatype = "text",             ### "numeric", "logical", "nominal", "ordinal", or "text"
  values = NA,                      ### Possible values; NA or a vector, e.g. c(1, 2, 3)
  labels = NA,                      ### Labels for the values; NA or e.g. c("no", "maybe", "sometimes")
  description = "So don’t worry and then I was of the view again based on some of the advice from my close friend that a small amount of alcohol is fine. (p.47)",					###	Provide the full description of the variable (e.g., questionnaire question)
...
####################################### ONLY FOR DETERMINANTS OF MATERNAL DRINKING BEHAVIOR VARIABLES
  ...
  determinant_recode = "risk perception, injunctive norm",			### Determinant recoded after expert meeting 
...
res$variable[[length(res$variable) + 1]] <- list(
  variable = "not to worry about what I had drunk",             ### Replace 'example' with variable name
  moment = 1,                       ### moment this variable was measured/manipulated
  type = "question",                ### "question", "aggregate", or "manipulation"
  datatype = "text",             ### "numeric", "logical", "nominal", "ordinal", or "text"
  values = NA,                      ### Possible values; NA or a vector, e.g. c(1, 2, 3)
  labels = NA,                      ### Labels for the values; NA or e.g. c("no", "maybe", "sometimes")
  description = "…and she then advised that not drinking is the safest way. But she said not to worry about what I had drunk, because there was a low – like, the – she said that the risk, um, of getting, I think, Fetal Alcohol Syndrome was more with continued drinking, and if I were to avoid drinking from then on, then that would be safest, and – and there would be unlikely to be any impact on – on my baby(p.47)",					###	Provide the full description of the variable (e.g., questionnaire question)
...
res$variable[[length(res$variable) + 1]] <- list(
  variable = "conflicting information",             ### Replace 'example' with variable name
  moment = 1,                       ### moment this variable was measured/manipulated
  type = "question",                ### "question", "aggregate", or "manipulation"
  datatype = "text",             ### "numeric", "logical", "nominal", "ordinal", or "text"
  values = NA,                      ### Possible values; NA or a vector, e.g. c(1, 2, 3)
  labels = NA,                      ### Labels for the values; NA or e.g. c("no", "maybe", "sometimes")
  description = "Finding quite conflicting information on it (p.48)",					###	Provide the full description of the variable (e.g., questionnaire question)
...
res$variable[[length(res$variable) + 1]] <- list(
  variable = "it’s hard enough as it is without depriving yourself of something that you want",             ### Replace 'example' with variable name
  moment = 1,                       ### moment this variable was measured/manipulated
  type = "question",                ### "question", "aggregate", or "manipulation"
  datatype = "text",             ### "numeric", "logical", "nominal", "ordinal", or "text"
  values = NA,                      ### Possible values; NA or a vector, e.g. c(1, 2, 3)
  labels = NA,                      ### Labels for the values; NA or e.g. c("no", "maybe", "sometimes")
  description = "If that’s what you feel like having, if that’s what you feel like putting in your mouth, whether it’s half a glass of wine or a curry or chocolate or chips or lettuce, do it because it’s hard enough as it is without depriving yourself of something that you want(p.49)",	###	Provide the full description of the variable (e.g., questionnaire question)
...
####################################### ONLY FOR DETERMINANTS OF MATERNAL DRINKING BEHAVIOR VARIABLES
  ...
  period = NA,               		### "before", "1st", "2nd", "3rd", "during", "after", "other"
  determinant_original = NA,		### If reported, how do the authors categorized the determinant, e.g., "knowledge", "attitude", "risk perception"
  determinant_recode = "attitudinal belief: benefits, self efficacy",			### Determinant recoded after expert meeting 
...
res$variable[[length(res$variable) + 1]] <- list(
  variable = "a standard drink or less on occasion while pregnant and breastfeeding",             ### Replace 'example' with variable name
  moment = 1,                       ### moment this variable was measured/manipulated
  type = "question",                ### "question", "aggregate", or "manipulation"
  datatype = "text",             ### "numeric", "logical", "nominal", "ordinal", or "text"
  values = NA,                      ### Possible values; NA or a vector, e.g. c(1, 2, 3)
  labels = NA,                      ### Labels for the values; NA or e.g. c("no", "maybe", "sometimes")
  description = "She believed it was okay to have a standard drink or less on occasion while pregnant and breastfeeding(p.50)",	###	Provide the full description of the variable (e.g., questionnaire question)
...
res$variable[[length(res$variable) + 1]] <- list(
  variable = "various sources of information, that it’s still conflicting",             ### Replace 'example' with variable name
  moment = 1,                       ### moment this variable was measured/manipulated
  type = "question",                ### "question", "aggregate", or "manipulation"
  datatype = "text",             ### "numeric", "logical", "nominal", "ordinal", or "text"
  values = NA,                      ### Possible values; NA or a vector, e.g. c(1, 2, 3)
  labels = NA,                      ### Labels for the values; NA or e.g. c("no", "maybe", "sometimes")
  description = "Yeah, I think, and I think it comes back to family and friends and sources of information, that it’s still conflicting and people might look at the Guidelines, but then they might have their mum say, oh well. I drank with you. And then, okay, well I can have a glass of wine. I really feel like one, so it’s all right then. And yeah, sometimes people relate to experience more than government guidelines(p.50-51)",	###	Provide the full description of the variable (e.g., questionnaire question)
