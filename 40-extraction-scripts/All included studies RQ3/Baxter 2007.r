...
res$sample$recruitmentSetting <- "clinic"; ### For example "antenatal clinic",or NA

### Sample Method
res$sample$native <- FALSE; ### TRUE for native/aboriginal populations (e.g. inuit, aboriginals, etc)

### Description of sample, in text
res$sample$description <- "low-income Iowa women"
