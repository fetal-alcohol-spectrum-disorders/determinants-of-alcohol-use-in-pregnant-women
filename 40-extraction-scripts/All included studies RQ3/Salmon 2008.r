...
res$sample$description <- "Birthmothers FASD"

### Description of geography of sample, in text
res$sample$geography <- "New Zealand"
...
res$variable[[length(res$variable) + 1]] <- list(
  variable = "Just wish that back when I was pregnant the emphasis was made don't drink any alcohol, as I was into heavy drinks. There was defenitely not any mention of FASD back then",             ### Replace 'example' with variable name
  moment = 1,                       ### moment this variable was measured/manipulated
  type = "question",                ### "question", "aggregate", or "manipulation"
  datatype = "text",             ### "numeric", "logical", "nominal", "ordinal", or "text"
  values = NA,                      ### Possible values; NA or a vector, e.g. c(1, 2, 3)
  labels = NA,                      ### Labels for the values; NA or e.g. c("no", "maybe", "sometimes")
  description = "Just wish that back when I was pregnant the emphasis was made don't drink any alcohol, as I was into heavy drinks. There was defenitely not any mention of FASD back then (p.e200)
"  ,					###	Provide the full description of the variable (e.g., questionnaire question)
