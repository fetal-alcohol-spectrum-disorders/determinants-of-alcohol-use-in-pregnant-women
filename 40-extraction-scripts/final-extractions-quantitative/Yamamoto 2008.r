...
res$sample$recruitmentSetting <- "obstetric clinic"; ### For example "antenatal clinic",or NA

### Sample Method
res$sample$native <- NA; ### TRUE for native/aboriginal populations (e.g. inuit, aboriginals, etc)

### Description of sample, in text
res$sample$description <- "500 obstetric clinical institutions"

### Description of geography of sample, in text
res$sample$geography <- "Japan"

### Study year, in text
res$sample$year <- 2002;

### Sample size, as a number
res$sample$size <- 14239;
...
res$univariate[[length(res$univariate) + 1]] <- list(
  variable = "knowledge regarding the effects of alcohol on fetuses",       ### Name of variable this result pertains to
  ...
  mean = NA,                        ### Mean or NA
  percentage = 3868 / 14239 * 100,                  ### Percentage that endorsed 1, or NA
...
res$univariate[[length(res$univariate) + 1]] <- list(
  ...
  median = NA,                      ### Median or NA
  mean = NA,                        ### Mean or NA
  percentage = 10371 / 14239 * 100,                  ### Percentage that endorsed 1, or NA
  sd = NA,                          ### Standard deviation, or NA
  qualitative = NA,                 ### Description (qualitative research)
  comment = NA                      ### Comment or NA
);
...
res$univariate[[length(res$univariate) + 1]] <- list(
  variable = "advise regarding risks of alcohol consumption",       ### Name of variable this result pertains to
  subsample = NA,                   ### Name of relevant subsample, or NA
  value = 1,                       ### Value this result pertains to
  moment = 1,                       ### Measurement moment this datapoint pertains to
  minimum = NA,                     ### Minimum or NA
  ...
  median = NA,                      ### Median or NA
  mean = NA,                        ### Mean or NA
  percentage = 3646 / 14239 * 100,                  ### Percentage that endorsed 1, or NA
  sd = NA,                          ### Standard deviation, or NA
  qualitative = NA,                 ### Description (qualitative research)
  comment = NA                      ### Comment or NA
);
...
res$univariate[[length(res$univariate) + 1]] <- list(
  ...
  median = NA,                      ### Median or NA
  mean = NA,                        ### Mean or NA
  percentage = 2645 / 14239 * 100,                  ### Percentage that endorsed 1, or NA
  sd = NA,                          ### Standard deviation, or NA
  qualitative = NA,                 ### Description (qualitative research)
  comment = NA                      ### Comment or NA
);
...
res$variable[[length(res$variable) + 1]] <- list(
  variable = "knowledge regarding the effects of alcohol on fetuses",             ### Replace 'example' with variable name
  ...
  description = "Knowledge regarding the effects of alcohol on fetuses(p.174)",					###	Provide the full description of the variable (e.g., questionnaire question)
...
res$variable[[length(res$variable) + 1]] <- list(
  variable = "advise regarding risks of alcohol consumption",             ### Replace 'example' with variable name
  moment = 1,                       ### moment this variable was measured/manipulated
  type = "question",                ### "question", "aggregate", or "manipulation"
  datatype = "numeric",             ### "numeric", "logical", "nominal", "ordinal", or "text"
  values = c(1,2),                      ### Possible values; NA or a vector, e.g. c(1, 2, 3)
  labels = c("no", "yes"),                      ### Labels for the values; NA or e.g. c("no", "maybe", "sometimes")
  description = "Whether advised regarding the risks of alcohol consumption (p.174)",					###	Provide the full description of the variable (e.g., questionnaire question)
