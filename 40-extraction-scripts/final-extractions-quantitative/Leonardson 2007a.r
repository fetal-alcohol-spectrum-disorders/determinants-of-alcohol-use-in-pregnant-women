...
res$association[[length(res$association) + 1]] <- list(
  variable1 = "any amount of alcohol was safe for pregnant women to drink",     ### Name of first variable
...
res$variable[[length(res$variable) + 1]] <- list(
  variable = "any amount of alcohol was safe for pregnant women to drink",             ### Replace 'example' with variable name
  moment = 1,                       ### moment this variable was measured/manipulated
  type = "question",                ### "question", "aggregate", or "manipulation"
  datatype = "logical",             ### "numeric", "logical", "nominal", "ordinal", or "text"
  values = c(1,2),                      ### Possible values; NA or a vector, e.g. c(1, 2, 3)
  labels = c("no", "yes"),                      ### Labels for the values; NA or e.g. c("no", "maybe", "sometimes")
  description = "Women, who believed any amount of alcohol was safe for pregnant women to drink (p.3)",	###	Provide the full description of the variable (e.g., questionnaire question)
