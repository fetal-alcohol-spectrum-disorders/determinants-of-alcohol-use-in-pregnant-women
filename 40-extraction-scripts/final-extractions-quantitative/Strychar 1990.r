...
res$sample$recruitmentSetting <- "hospitals"; ### For example "antenatal clinic",or NA
...
### Study year, in text
res$sample$year <- 1986;

### Sample size, as a number
res$sample$size <- 95;		##drinkers
...
res$univariate[[length(res$univariate) + 1]] <- list(
  variable = "Could name at least one effect of consuming large amounts of alcohol during  pregnancy",       ### Name of variable this result pertains to
  ...
  comment = "62% van 95)"                     ### Comment or NA
);
...
res$univariate[[length(res$univariate) + 1]] <- list(
  variable = "Were aware that small amounts of alcohol were associated with the possible risk of having a lower birthweight infant",       ### Name of variable this result pertains to
  subsample = NA,                   ### Name of relevant subsample, or NA
  value = NA,                       ### Value this result pertains to
  moment = 1,                       ### Measurement moment this datapoint pertains to
  minimum = NA,                     ### Minimum or NA
  ...
  sd = NA,                          ### Standard deviation, or NA
  qualitative = NA,                 ### Description (qualitative research)
  comment = "15% van 95)"                     ### Comment or NA
);
...
res$univariate[[length(res$univariate) + 1]] <- list(
  variable = "Identified no alcohol as a safe amount to consume during pregnancy",       ### Name of variable this result pertains to
  subsample = NA,                   ### Name of relevant subsample, or NA
  value = NA,                       ### Value this result pertains to
  moment = 1,                       ### Measurement moment this datapoint pertains to
  minimum = NA,                     ### Minimum or NA
  ...
  median = NA,                      ### Median or NA
  mean = NA,                        ### Mean or NA
  percentage = 48.0,                  ### Percentage that endorsed 1, or NA
  sd = NA,                          ### Standard deviation, or NA
  qualitative = NA,                 ### Description (qualitative research)
  comment = "48% van 95)"                     ### Comment or NA
);
...
res$univariate[[length(res$univariate) + 1]] <- list(
  variable = "Women perceived few barriers in managing their alcohol consumption during pregnancy",       ### Name of variable this result pertains to
  subsample = NA,                   ### Name of relevant subsample, or NA
  value = NA,                       ### Value this result pertains to
  moment = 1,                       ### Measurement moment this datapoint pertains to
  minimum = NA,                     ### Minimum or NA
  ...
  sd = NA,                          ### Standard deviation, or NA
  qualitative = NA,                 ### Description (qualitative research)
  comment = "83% no perceived obstacles"                     ### Comment or NA
);
...
res$variable[[length(res$variable) + 1]] <- list(
  variable = "Could name at least one effect of consuming large amounts of alcohol during  pregnancy",             ### Replace 'example' with variable name
  moment = 1,                       ### moment this variable was measured/manipulated
  type = "question",                ### "question", "aggregate", or "manipulation"
  datatype = "numeric",             ### "numeric", "logical", "nominal", "ordinal", or "text"
  values = NA,                      ### Possible values; NA or a vector, e.g. c(1, 2, 3)
  labels = NA,                      ### Labels for the values; NA or e.g. c("no", "maybe", "sometimes")
  description = "…Could name at least one effect of consuming large amounts of alcohol during  pregnancy (p.464)",					###	Provide the full description of the variable (e.g., questionnaire question)
...
res$variable[[length(res$variable) + 1]] <- list(
  variable = "Were aware that small amounts of alcohol were associated with the possible risk of having a lower birthweight infant",             ### Replace 'example' with variable name
  moment = 1,                       ### moment this variable was measured/manipulated
  type = "question",                ### "question", "aggregate", or "manipulation"
  datatype = "numeric",             ### "numeric", "logical", "nominal", "ordinal", or "text"
  values = NA,                      ### Possible values; NA or a vector, e.g. c(1, 2, 3)
  labels = NA,                      ### Labels for the values; NA or e.g. c("no", "maybe", "sometimes")
  description = "..Were aware that small amounts of alcohol were associated with the possible risk of having a lower birthweight infant (p.464)",					###	Provide the full description of the variable (e.g., questionnaire question)
...
res$variable[[length(res$variable) + 1]] <- list(
  variable = "Identified no alcohol as a safe amount to consume during pregnancy",             ### Replace 'example' with variable name
  moment = 1,                       ### moment this variable was measured/manipulated
  type = "question",                ### "question", "aggregate", or "manipulation"
  datatype = "numeric",             ### "numeric", "logical", "nominal", "ordinal", or "text"
  values = NA,                      ### Possible values; NA or a vector, e.g. c(1, 2, 3)
  labels = NA,                      ### Labels for the values; NA or e.g. c("no", "maybe", "sometimes")
  description = "..Identified no alcohol as a safe amount to consume during pregnancy (p.464)",					###	Provide the full description of the variable (e.g., questionnaire question)
...
res$variable[[length(res$variable) + 1]] <- list(
  variable = "Women perceived few barriers in managing their alcohol consumption during pregnancy",             ### Replace 'example' with variable name
  moment = 1,                       ### moment this variable was measured/manipulated
  type = "question",                ### "question", "aggregate", or "manipulation"
  datatype = "numeric",             ### "numeric", "logical", "nominal", "ordinal", or "text"
  values = NA,                      ### Possible values; NA or a vector, e.g. c(1, 2, 3)
  labels = NA,                      ### Labels for the values; NA or e.g. c("no", "maybe", "sometimes")
  description = "Women perceived few barriers in managing their alcohol consumption during pregnancy (e.g., social events, desire to drink, stress) (p.465)",					###	Provide the full description of the variable (e.g., questionnaire question)
 
####################################### ONLY FOR DETERMINANTS OF MATERNAL DRINKING BEHAVIOR VARIABLES
  dataCollectionMethod = "interview",        ### "self-report" or "interview"
  timeframe = NA,                   ### "retrospective" vs "concurrent" 
  period = NA,               		### "before", "1st", "2nd", "3rd", "during", "after", "other"
  determinant_original = "belief",		### If reported, how do the authors categorized the determinant, e.g., "knowledge", "attitude", "risk perception"
