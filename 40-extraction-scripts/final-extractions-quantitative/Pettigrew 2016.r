...
res$sample$description <- "Tree anual national surveys"

### Description of geography of sample, in text
res$sample$geography <- "Australia"

### Study year, in text
res$sample$year <- 2012;
res$sample$endyear <- 2014;
...
res$univariate[[length(res$univariate) + 1]] <- list(
  variable = "Belief should reduce the amount of alcohol consumed",       ### Name of variable this result pertains to
  ...
  mean = 3.14,                        ### Mean or NA
  percentage = 47,                  ### Percentage that endorsed 1, or NA
  sd = 1.37,                          ### Standard deviation, or NA
  qualitative = NA,                 ### Description (qualitative research)
  comment = NA                      ### Comment or NA
);

res$univariate[[length(res$univariate) + 1]] <- list(
  variable = "Belief will actually reduce amount of alcohol consumed",       ### Name of variable this result pertains to
  subsample = NA,                   ### Name of relevant subsample, or NA
  value = NA,                       ### Value this result pertains to
  moment = 1,                       ### Measurement moment this datapoint pertains to
  minimum = NA,                     ### Minimum or NA
...
res$univariate[[length(res$univariate) + 1]] <- list(
  variable = "Intention five or more drinks",       ### Name of variable this result pertains to
  subsample = NA,                   ### Name of relevant subsample, or NA
  value = NA,                       ### Value this result pertains to
  moment = 1,                       ### Measurement moment this datapoint pertains to
  minimum = NA,                     ### Minimum or NA
  ...
  sd = 1.50,                          ### Standard deviation, or NA
  qualitative = NA,                 ### Description (qualitative research)
  comment = NA                      ### Comment or NA
);
...
res$variable[[length(res$variable) + 1]] <- list(
  variable = "Belief should reduce the amount of alcohol consumed",             ### Replace 'example' with variable name
  moment = 1,                       ### moment this variable was measured/manipulated
  type = "question",                ### "question", "aggregate", or "manipulation"
  datatype = "numeric",             ### "numeric", "logical", "nominal", "ordinal", or "text"
  values = NA,                      ### Possible values; NA or a vector, e.g. c(1, 2, 3)
  labels = NA,                      ### Labels for the values; NA or e.g. c("no", "maybe", "sometimes")
  description = "To what extent do you think that you, personally, should reduce the amount of alcohol consumed(p.1423 table 2)",					###	Provide the full description of the variable (e.g., questionnaire question)
...
res$variable[[length(res$variable) + 1]] <- list(
  variable = "Belief will actually reduce amount of alcohol consumed",             ### Replace 'example' with variable name
  moment = 1,                       ### moment this variable was measured/manipulated
  type = "question",                ### "question", "aggregate", or "manipulation"
  datatype = "numeric",             ### "numeric", "logical", "nominal", "ordinal", or "text"
  values = NA,                      ### Possible values; NA or a vector, e.g. c(1, 2, 3)
  labels = NA,                      ### Labels for the values; NA or e.g. c("no", "maybe", "sometimes")
  description = "To what extent do you think that you, personally, will actually reduce amount of alcohol consumed (p.1423 table 2)  ",					###	Provide the full description of the variable (e.g., questionnaire question)
...
res$variable[[length(res$variable) + 1]] <- list(
  variable = "Intention five or more drinks",             ### Replace 'example' with variable name
  moment = 1,                       ### moment this variable was measured/manipulated
  type = "question",                ### "question", "aggregate", or "manipulation"
  datatype = "numeric",             ### "numeric", "logical", "nominal", "ordinal", or "text"
  values = NA,                      ### Possible values; NA or a vector, e.g. c(1, 2, 3)
  labels = NA,                      ### Labels for the values; NA or e.g. c("no", "maybe", "sometimes")
  description = "Do you intend to drink five or more standard alcoholic beverages in a single session in the next two weeks (p.1423 table 2)",					###	Provide the full description of the variable (e.g., questionnaire question)
