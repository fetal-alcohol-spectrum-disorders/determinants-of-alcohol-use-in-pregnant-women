...
res$association[[length(res$association) + 1]] <- list(
  variable1 = "Awareness of harmful effects of alcohol",     ### Name of first variable
  ...
  raw.table = matrix(c(71, 174,           ### Raw crosstable; can be used
                       15, 120),          ### to compute chi square or
...
res$variable[[length(res$variable) + 1]] <- list(
  variable = "Awareness of harmful effects of alcohol",             ### Replace 'example' with variable name
  ...
  description = "Awareness of harmful effects of alcohol (p.12, table figure 2)",					###	Provide the full description of the variable (e.g., questionnaire question)
...
####################################### ONLY FOR DETERMINANTS OF MATERNAL DRINKING BEHAVIOR VARIABLES
  ...
  determinant_original = "awareness",		### If reported, how do the authors categorized the determinant, e.g., "knowledge", "attitude", "risk perception"
