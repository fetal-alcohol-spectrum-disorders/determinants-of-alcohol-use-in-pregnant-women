...
res$association[[length(res$association) + 1]] <- list(
  ...
  t = NA,                           ### t-value
  raw.table = matrix(c(61*.92, 10*.6, 24*.71,           ### Raw crosstable; can be used
                       61*.08, 10*.4, 24*.29),          ### to compute chi square or
...
res$association[[length(res$association) + 1]] <- list(
  ...
  df2 = NA,                         ### for anova, second degrees of freedom (denominator)
  t = NA,                           ### t-value
  raw.table = matrix(c(61*.78, 10*.5, 24*.75,           ### Raw crosstable; can be used
                       61*.22, 10*.5, 24*.25),          ### to compute chi square or
                     ncol=3, byrow=TRUE), ### Cramer's V or OR later
  F = NA,                           ### F-value
  chisq = NA,                       ### Chi square value
  r = NA,                           ### Pearson correlation
...
res$univariate[[length(res$univariate) + 1]] <- list(
  variable = "Thinks alcohol is harmful to baby's health",       ### Name of variable this result pertains to
  ...
  mean = NA,                        ### Mean or NA
  percentage = 83.0,                  ### Percentage that endorsed 1, or NA
...
res$univariate[[length(res$univariate) + 1]] <- list(
  variable = "Thinks alcohol is harmful to own health",       ### Name of variable this result pertains to
  subsample = NA,                   ### Name of relevant subsample, or NA
  value = NA,                       ### Value this result pertains to
  moment = 1,                       ### Measurement moment this datapoint pertains to
  minimum = NA,                     ### Minimum or NA
  ...
  median = NA,                      ### Median or NA
  mean = NA,                        ### Mean or NA
  percentage = 74.0,                  ### Percentage that endorsed 1, or NA
  sd = NA,                          ### Standard deviation, or NA
  qualitative = NA,                 ### Description (qualitative research)
  comment = NA                      ### Comment or NA
);
...
res$variable[[length(res$variable) + 1]] <- list(
  variable = "Alcohol during Pregnancy",             ### Replace 'example' with variable name
  moment = 1,                       ### moment this variable was measured/manipulated
  type = "question",                ### "question", "aggregate", or "manipulation"
  datatype = "numeric",             ### "numeric", "logical", "nominal", "ordinal", or "text"
  values = c(1,2,3),                      ### Possible values; NA or a vector, e.g. c(1, 2, 3)
  labels = c("light drinkers", "reduced heavy drinkers", "sustained heavy drinkers"),                      ### Labels for the values; NA or e.g. c("no", "maybe", "sometimes")
  description = "p.45 table 7",	###	Provide the full description of the variable (e.g., questionnaire question)
...
res$variable[[length(res$variable) + 1]] <- list(
  variable = "Thinks alcohol is harmful to baby's health",             ### Replace 'example' with variable name
  moment = 1,                       ### moment this variable was measured/manipulated
  type = "question",                ### "question", "aggregate", or "manipulation"
  datatype = "numeric",             ### "numeric", "logical", "nominal", "ordinal", or "text"
  values = NA,                      ### Possible values; NA or a vector, e.g. c(1, 2, 3)
  labels = NA,                      ### Labels for the values; NA or e.g. c("no", "maybe", "sometimes")
  description = "Thinks alcohol is harmful to baby's health (p.45 table 7)",	###	Provide the full description of the variable (e.g., questionnaire question)
...
res$variable[[length(res$variable) + 1]] <- list(
  variable = "Thinks alcohol is harmful to own health",             ### Replace 'example' with variable name
  moment = 1,                       ### moment this variable was measured/manipulated
  type = "question",                ### "question", "aggregate", or "manipulation"
  datatype = "numeric",             ### "numeric", "logical", "nominal", "ordinal", or "text"
  values = NA,                      ### Possible values; NA or a vector, e.g. c(1, 2, 3)
  labels = NA,                      ### Labels for the values; NA or e.g. c("no", "maybe", "sometimes")
  description = "Thinks alcohol is harmful to own health (p.45 table 7)",	###	Provide the full description of the variable (e.g., questionnaire question)
