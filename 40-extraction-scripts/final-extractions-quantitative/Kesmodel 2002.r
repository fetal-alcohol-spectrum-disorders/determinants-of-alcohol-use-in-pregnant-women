...
res$sample$recruitmentSetting <- "antenatal care"; ### For example "antenatal clinic",or NA
...
res$univariate[[length(res$univariate) + 1]] <- list(
  variable = "Should women pay attention to intake?",       ### Name of variable this result pertains to
  subsample = "binge drinkers",                   ### Name of relevant subsample, or NA
  value = 1,                       ### Value this result pertains to
  moment = 1,                       ### Measurement moment this datapoint pertains to
  minimum = NA,                     ### Minimum or NA
  maximum = NA,                     ### Maximum or NA
...
res$univariate[[length(res$univariate) + 1]] <- list(
  ...
  median = NA,                      ### Median or NA
  mean = NA,                        ### Mean or NA
  percentage = 56,                  ### Percentage that endorsed 1, or NA
  sd = NA,                          ### Standard deviation, or NA
  qualitative = NA,                 ### Description (qualitative research)
  comment = NA                      ### Comment or NA
);
...
res$variable[[length(res$variable) + 1]] <- list(
  variable = "pregnant women should pay attention to alcohol",             ### Replace 'example' with variable name
  moment = 1,                       ### moment this variable was measured/manipulated
  type = "question",                ### "question", "aggregate", or "manipulation"
  datatype = "logical",             ### "numeric", "logical", "nominal", "ordinal", or "text"
  values = NA,                      ### Possible values; NA or a vector, e.g. c(1, 2, 3)
  labels = NA,                      ### Labels for the values; NA or e.g. c("no", "maybe", "sometimes")
  description = "Do you personally believe that a woman who is pregnant should pay attention to her alcohol intake? If yes: in what way? (p.1559 appendix 1)",					###	Provide the full description of the variable (e.g., questionnaire question)
...
res$variable[[length(res$variable) + 1]] <- list(
  variable = "Should women pay attention to intake?",             ### Replace 'example' with variable name
  moment = 1,                       ### moment this variable was measured/manipulated
  type = "question",                ### "question", "aggregate", or "manipulation"
  datatype = "nominal",             ### "numeric", "logical", "nominal", "ordinal", or "text"
  values = c(1,2,3,4,5,6),                      ### Possible values; NA or a vector, e.g. c(1, 2, 3)
  labels = c("no", "yes, she should not drink at all", "yes, but a drink once in a while/ a drink on festive occasions is acceptable", "yes, she should not drink more than 1-3 drinks/month", "yes, she should not drink more than 1-6 drinks/week","yes, she should not drink more than 1 drink/day" ),                      ### Labels for the values; NA or e.g. c("no", "maybe", "sometimes")
  description = "Should a pregnant woman pay attention to her alcohol intake? (p. 1556, table 2)",	###	Provide the full description of the variable (e.g., questionnaire question)
