...
res$sample$size <- 171;		### 171 zwangeren, 41 partners
...
res$univariate[[length(res$univariate) + 1]] <- list(
  variable = "1-2 units safe amount to drink while pregnant",       ### Name of variable this result pertains to
  ...
  mean = NA,                        ### Mean or NA
  percentage = 16/171*100,                  ### Percentage that endorsed 1, or NA
...
res$univariate[[length(res$univariate) + 1]] <- list(
  variable = "more than 3 units safe amount to drink while pregnant",       ### Name of variable this result pertains to
  subsample = NA,                   ### Name of relevant subsample, or NA
  value = 1,                       ### Value this result pertains to
  moment = 1,                       ### Measurement moment this datapoint pertains to
  minimum = NA,                     ### Minimum or NA
  ...
  median = NA,                      ### Median or NA
  mean = NA,                        ### Mean or NA
  percentage = 2/171*100,                  ### Percentage that endorsed 1, or NA
  sd = NA,                          ### Standard deviation, or NA
  qualitative = NA,                 ### Description (qualitative research)
  comment = NA                      ### Comment or NA
);
...
res$variable[[length(res$variable) + 1]] <- list(
  variable = "1-2 units safe amount to drink while pregnant",             ### Replace 'example' with variable name
  moment = 1,                       ### moment this variable was measured/manipulated
  type = "question",                ### "question", "aggregate", or "manipulation"
  datatype = "numeric",             ### "numeric", "logical", "nominal", "ordinal", or "text"
  values = NA,                      ### Possible values; NA or a vector, e.g. c(1, 2, 3)
  labels = NA,   ### Labels for the values; NA or e.g. c("no", "maybe", "sometimes")
  description = "What level of alcohol do you think is safe in pregnancy(p.622)",	###	Provide the full description of the variable (e.g., questionnaire question)
...
res$variable[[length(res$variable) + 1]] <- list(
  variable = "more than 3 units safe amount to drink while pregnant",             ### Replace 'example' with variable name
  moment = 1,                       ### moment this variable was measured/manipulated
  type = "question",                ### "question", "aggregate", or "manipulation"
  datatype = "numeric",             ### "numeric", "logical", "nominal", "ordinal", or "text"
  values = NA,                      ### Possible values; NA or a vector, e.g. c(1, 2, 3)
