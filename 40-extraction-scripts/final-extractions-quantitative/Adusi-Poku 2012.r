...
On page 58 it is stated that 20.4% of the pregnant women drank alcohol
...
res$univariate[[length(res$univariate) + 1]] <- list(
  variable = "Alcohol detrimental pregnancy",       ### Name of variable this result pertains to
...
res$univariate[[length(res$univariate) + 1]] <- list(
  ...
  subsample = NA,                   ### Name of relevant subsample, or NA
  value = NA,                       ### Value this result pertains to
  moment = 2,                       ### Measurement moment this datapoint pertains to
  minimum = NA,                     ### Minimum or NA
  maximum = NA,                     ### Maximum or NA
  median = NA,                      ### Median or NA
  mean = NA,                        ### Mean or NA
...
res$univariate[[length(res$univariate) + 1]] <- list(
  ...
  median = NA,                      ### Median or NA
  mean = NA,                        ### Mean or NA
  percentage = 14.4,                  ### Percentage that endorsed 1, or NA
  sd = NA,                          ### Standard deviation, or NA
  qualitative = NA,                 ### Description (qualitative research)
  comment = NA                      ### Comment or NA
);
...
res$univariate[[length(res$univariate) + 1]] <- list(
  variable = "Alcohol detrimental pregnancy on mother",       ### Name of variable this result pertains to
  subsample = NA,                   ### Name of relevant subsample, or NA
...
res$univariate[[length(res$univariate) + 1]] <- list(
  ...
  median = NA,                      ### Median or NA
  mean = NA,                        ### Mean or NA
  percentage = 16.6,                  ### Percentage that endorsed 1, or NA
  sd = NA,                          ### Standard deviation, or NA
  qualitative = NA,                 ### Description (qualitative research)
  comment = NA                      ### Comment or NA
);
...
res$univariate[[length(res$univariate) + 1]] <- list(
  variable = "Alcohol detrimental pregnancy on baby",       ### Name of variable this result pertains to
  subsample = NA,                   ### Name of relevant subsample, or NA
  value = 1,                       ### Value this result pertains to
  moment = 1,                       ### Measurement moment this datapoint pertains to
  minimum = NA,                     ### Minimum or NA
  ...
  median = NA,                      ### Median or NA
  mean = NA,                        ### Mean or NA
  percentage = 40.3,                  ### Percentage that endorsed 1, or NA
  sd = NA,                          ### Standard deviation, or NA
  qualitative = NA,                 ### Description (qualitative research)
  comment = NA                      ### Comment or NA
);
res$univariate[[length(res$univariate) + 1]] <- list(
  ...
  median = NA,                      ### Median or NA
  mean = NA,                        ### Mean or NA
  percentage = 41.1,                  ### Percentage that endorsed 1, or NA
  sd = NA,                          ### Standard deviation, or NA
  qualitative = NA,                 ### Description (qualitative research)
  comment = NA                      ### Comment or NA
);
...
res$variable[[length(res$variable) + 1]] <- list(
  variable = "Alcohol detrimental pregnancy",             ### Replace 'example' with variable name
  ...
  labels = c("no","yes","don't know"),                      ### Labels for the values; NA or e.g. c("no", "maybe", "sometimes")
  description = "PPN answered 'yes' on: Alcohol could be detrimental to the pregnant woman(p.58 table 2)",	###	Provide the full description of the variable (e.g., questionnaire question)
...
res$variable[[length(res$variable) + 1]] <- list(
  variable = "Alcohol detrimental pregnancy on mother",             ### Replace 'example' with variable name
  moment = 1,                       ### moment this variable was measured/manipulated
  type = "question",                ### "question", "aggregate", or "manipulation"
  datatype = "ordinal",             ### "numeric", "logical", "nominal", "ordinal", or "text"
  values = c(1,2,3,4,5),                      ### Possible values; NA or a vector, e.g. c(1, 2, 3)
  labels = c("five correct answers", "four correct answers", "three correct answers", "less than two correct answers", "don't know"),                      ### Labels for the values; NA or e.g. c("no", "maybe", "sometimes")
  description = "Detrimental effects on alcohol on mother such as disrupt family relations (p.58 table 3)",	###	Provide the full description of the variable (e.g., questionnaire question)
...
res$variable[[length(res$variable) + 1]] <- list(
  variable = "Alcohol detrimental pregnancy on baby",             ### Replace 'example' with variable name
  moment = 1,                       ### moment this variable was measured/manipulated
  type = "question",                ### "question", "aggregate", or "manipulation"
  datatype = "ordinal",             ### "numeric", "logical", "nominal", "ordinal", or "text"
  values = c(1,2,3),                      ### Possible values; NA or a vector, e.g. c(1, 2, 3)
  labels = c("three correct answers", "less than two correct answers", "don't know"),           
  description = "Detrimental effects on alcohol on baby such as strctural deficits (p.58 table 3)",	###	Provide the full description of the variable (e.g., questionnaire question)
